    ...
    <>
      <div className="sideNav">
        {slides.map( ( slideName ) => {
          return (
            <Link activeClass="active" className={slideName} to={slideName} spy={true} smooth={true} duration={500}> <FaCircle name={slideName} color={ clicked === slideName ? "#333333" : "#999999" } size={35} onClick={() => clickFunc(slideName)}/> </Link>
          )
        })}
      </div>
